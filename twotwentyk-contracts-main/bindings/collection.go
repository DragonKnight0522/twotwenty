...
// CreateCollection is a paid mutator transaction binding the contract method 0xf8ead6d3.
//
// Solidity: function createCollection(string _tokenURI, uint256 _standardAmount, uint256 _premiumAmount, uint256 _elliteAmount, uint256 _totalAmount) payable returns(uint256, string)
func (_Collection *CollectionTransactor) CreateCollection(opts *bind.TransactOpts, _tokenURI string, _standardAmount *big.Int, _premiumAmount *big.Int, _elliteAmount *big.Int, _totalAmount *big.Int) (*types.Transaction, error) {
	return _Collection.contract.Transact(opts, "createCollection", _tokenURI, _standardAmount, _premiumAmount, _elliteAmount, _totalAmount)
}

// CreateCollection is a paid mutator transaction binding the contract method 0xf8ead6d3.
//
// Solidity: function createCollection(string _tokenURI, uint256 _standardAmount, uint256 _premiumAmount, uint256 _elliteAmount, uint256 _totalAmount) payable returns(uint256, string)
func (_Collection *CollectionSession) CreateCollection(_tokenURI string, _standardAmount *big.Int, _premiumAmount *big.Int, _elliteAmount *big.Int, _totalAmount *big.Int) (*types.Transaction, error) {
	return _Collection.Contract.CreateCollection(&_Collection.TransactOpts, _tokenURI, _standardAmount, _premiumAmount, _elliteAmount, _totalAmount)
}

// CreateCollection is a paid mutator transaction binding the contract method 0xf8ead6d3.
//
// Solidity: function createCollection(string _tokenURI, uint256 _standardAmount, uint256 _premiumAmount, uint256 _elliteAmount, uint256 _totalAmount) payable returns(uint256, string)
func (_Collection *CollectionTransactorSession) CreateCollection(_tokenURI string, _standardAmount *big.Int, _premiumAmount *big.Int, _elliteAmount *big.Int, _totalAmount *big.Int) (*types.Transaction, error) {
	return _Collection.Contract.CreateCollection(&_Collection.TransactOpts, _tokenURI, _standardAmount, _premiumAmount, _elliteAmount, _totalAmount)
}

// Initialize is a paid mutator transaction binding the contract method 0xcc2a9a5b.
//
// Solidity: function initialize(address _packFactory, address _categoryFactory, address _yearFactory, address _dayMonthFactory, address _craftingFactory, address _triggerFactory) returns()
func (_Collection *CollectionTransactor) Initialize(opts *bind.TransactOpts, _packFactory common.Address, _categoryFactory common.Address, _yearFactory common.Address, _dayMonthFactory common.Address, _craftingFactory common.Address, _triggerFactory common.Address) (*types.Transaction, error) {
	return _Collection.contract.Transact(opts, "initialize", _packFactory, _categoryFactory, _yearFactory, _dayMonthFactory, _craftingFactory, _triggerFactory)
}

// Initialize is a paid mutator transaction binding the contract method 0xcc2a9a5b.
//
// Solidity: function initialize(address _packFactory, address _categoryFactory, address _yearFactory, address _dayMonthFactory, address _craftingFactory, address _triggerFactory) returns()
func (_Collection *CollectionSession) Initialize(_packFactory common.Address, _categoryFactory common.Address, _yearFactory common.Address, _dayMonthFactory common.Address, _craftingFactory common.Address, _triggerFactory common.Address) (*types.Transaction, error) {
	return _Collection.Contract.Initialize(&_Collection.TransactOpts, _packFactory, _categoryFactory, _yearFactory, _dayMonthFactory, _craftingFactory, _triggerFactory)
}

// Initialize is a paid mutator transaction binding the contract method 0xcc2a9a5b.
//
// Solidity: function initialize(address _packFactory, address _categoryFactory, address _yearFactory, address _dayMonthFactory, address _craftingFactory, address _triggerFactory) returns()
func (_Collection *CollectionTransactorSession) Initialize(_packFactory common.Address, _categoryFactory common.Address, _yearFactory common.Address, _dayMonthFactory common.Address, _craftingFactory common.Address, _triggerFactory common.Address) (*types.Transaction, error) {
	return _Collection.Contract.Initialize(&_Collection.TransactOpts, _packFactory, _categoryFactory, _yearFactory, _dayMonthFactory, _craftingFactory, _triggerFactory)
}
...
// FilterCollectionCreated is a free log retrieval operation binding the contract event 0xfef410e8debc1749c63e587a214c2c77bedf014092686ff45b910c64465a0925.
//
// Solidity: event CollectionCreated(uint256 tokenId, string tokenURI, address pack, address category, address year, address daymonth, address crafting, address trigger)
...
// WatchCollectionCreated is a free log subscription operation binding the contract event 0xfef410e8debc1749c63e587a214c2c77bedf014092686ff45b910c64465a0925.
//
// Solidity: event CollectionCreated(uint256 tokenId, string tokenURI, address pack, address category, address year, address daymonth, address crafting, address trigger)
...
// ParseCollectionCreated is a log parse operation binding the contract event 0xfef410e8debc1749c63e587a214c2c77bedf014092686ff45b910c64465a0925.
//
// Solidity: event CollectionCreated(uint256 tokenId, string tokenURI, address pack, address category, address year, address daymonth, address crafting, address trigger)
